    ...
    background: yellow;
        ...
        <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Welcome to ABC</h3>
        ...
        <section id="list">
            <div class="container mt-3 pt-2">
                ...
                <hr class="divider">
                <?php
                $vacancy = $conn->query("SELECT * FROM vacancy");
                ...
                <div class="card vacancy-list" data-id="<?php echo $row['id'] ?>">
                    <div class="card-body">
                        <h3><b class="filter-txt"><?php echo $row['job_name'] ?></b></h3>
                        <span><small><?php echo $row['employer'] ?></small></span>
                        <hr>
