...
<div class="container-fluid">
	<form id="manage-application">
		...
		<input type="hidden" name="job_name" value="<?php echo $_GET['id'] ?>">
	<div class="col-md-12">
		<div class="row">
			<h3>Application Form for <?php echo $job_name ?></h3>
		</div>
		<hr>
		...
		<div class="row form-group">
			<div class="col-md-7">
				...
				<input type="text" class="form-control" name="current_employer" required="">
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-7">
		...
		<div class="row form-group">
			<div class="input-group col-md-4 mb-3">
			  ...
			  <div class="custom-file">
			    <input type="file" class="custom-file-input" id="resume" onchange="displayfname(this,$(this))" name="resume" accept="application/msword, application/pdf">
